...
<body>
    ...
    <div id="badge" class="badge">
        <div class="badge-header">
            ...
            <br>
            <img src="<?= $user['passport_url'] ?? 'https://www.shutterstock.com/image-vector/man-shirt-tie-businessman-avatar-600nw-548848999.jpg' ?> " style="max-width: 150px;border-radius: 6px;">
