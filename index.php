...
<body>
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-contact">
                    ...
                    <ul>
                        <li>
                            <h6>Email</h6>
                            <a href="https://live.themewild.com/cdn-cgi/l/email-protection#4821262e27082d30292538242d662b2725"><i class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="91f8fff7fed1f4e9f0fce1fdf4bff2fefc">[email&#160;protected]</span></a>
                        </li>
                        <li>
                            <h6>Phone</h6>
    ...
    <main class="main">
        ...
        <!-- about area -->
        <div class="about-area py-20" id="about">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
        ...
        <!-- car dealer -->
        <div class="car-dealer pb-120" id="dealers">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="site-heading text-center">
